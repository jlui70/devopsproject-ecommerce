...
using DevOpsProjectEcommerce.SqsHandler.Exceptions;
using DevOpsProjectEcommerce.SqsHandler.Models;
using DevOpsProjectEcommerce.Utils.Encryption;

namespace DevOpsProjectEcommerce.SqsHandler.Implementations
{
