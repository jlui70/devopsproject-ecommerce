...
using DevOpsProjectEcommerce.IdentityServer.Domain.Repositories.Configurations;

namespace DevOpsProjectEcommerce.IdentityServer.Domain.Repositories.Contexts
{
